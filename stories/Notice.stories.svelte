<script module lang="ts">
  ...
  const OVERVIEW = [
    ...
    '',
    'It is visible text with `role="status"`, so it is announced by being rendered rather than',
    'duplicated into the live region and heard twice. That split is the reason a rejection never',
    'reaches `Announcer`.',
    '',
